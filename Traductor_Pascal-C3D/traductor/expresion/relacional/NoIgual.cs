...
{
    class NoIgual : Expresion
    {
        private Expresion left;
        private Expresion right;

        public NoIgual(Expresion left, Expresion right, int line, int column) : base(line,column)
        {
            this.left = left;
            this.right = right;
            ...
            switch (_left.type.type)
            {
                ...
                case Types.BOOLEAN:
                    ...
                    if (_right.type.type == Types.BOOLEAN)
                    {
                        ...
                        retorno.trueLabel = falseLabel;
                        retorno.falseLabel = trueLabel;
                        return retorno;
                    }
                    break;
                case Types.STRING:
